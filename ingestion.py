...
import torch
from config import VECTOR_STORE_DIR, CONCURRENT_INGESTION
...
class Stage1Ingestor:
    ...
    """
    def __init__(self, base_store_dir: Optional[str] = None, concurrent: Optional[bool] = None):
...
if __name__ == "__main__":
    ...
    ingestor = Stage1Ingestor(concurrent=concurrent_flag)
